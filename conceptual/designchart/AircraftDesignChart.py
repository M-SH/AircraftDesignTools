...
if __name__ == "__main__":
    ...
    cessna162.cl_ldg = 0.5
    cessna162.cd_ldg = 0.07
    ...
    v_upsilon_kcas = Gudmundsson.calc_best_roc_speed_single_engine_cas(W_S)

    t_w_roc_sealevel = AircraftPerformance.rate_of_climb_imp(10, cessna162.roc, cessna162.c_d_min, k, v_upsilon_kcas, airport_altitude_m)
    ...
    service_ceiling_m = Convert().convert(cessna162.service_ceiling, Convert.FOOT, Convert.METER)
    v_upsilon_kcas = Gudmundsson.calc_best_roc_speed_single_engine_cas(W_S)

    t_w_service_ceiling = AircraftPerformance.service_ceiling_imp(W_S, cessna162.c_d_min, k, v_upsilon_kcas, service_ceiling_m)

    w_s_landing = AircraftPerformance.landing_distance_imp(1369, 0.0, 2.029, cessna162.cl_ldg, cessna162.cd_ldg, h_obst_ft=50)
